...
- template: text-block
  ...
  text_block: |-
    ...
    Applications for the summer program are open and we have extended the application deadline- Please send completed applications along with a resume to veskridge@bwaf.org by Monday, June 20, 2022.
- template: text-block
