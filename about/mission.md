...
- template: text-block
  ...
  text_block: BWAF advocates for gender equity in leadership and recognition in the
    ...
    and achievements in the built realm, educating the public, and transforming industry
    practices.
  include_left-hand_column_text_: true
  lefthand_text:
    header_type: Text with Download
    text: Read our Statement on Sexual Misconduct
    download: https://www.dropbox.com/s/vsx39amlcbrdepe/BWAF%20Statement%20on%20Sexual%20Misconduct.pdf?dl=0
...
- template: text-block
  ...
  text_block: Through exhibitions, websites, media, public and invitation-only programs,
    ...
    work, we seek to build global change.
  include_left-hand_column_text_: true
  section_break: false
  lefthand_text:
    header_type: Text with Download
    text: Read our Statement on Racial Violence
    download: https://www.dropbox.com/s/vsa9d2i13ay8jy2/BWAF%20Statement%20on%20Racial%20Violence.pdf?dl=0
    link_url: ''
    link_text: Download the statement
- template: image-block
  ...
  section_break: false
page_sections: []
description: Beverly Willis Architecture Foundation (BWAF) is leading a cultural revolution
